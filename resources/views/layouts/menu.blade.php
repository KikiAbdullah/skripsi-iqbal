    ...
    <div class="container-fluid">
        <div class="flex-1">
            <a href="{{ route('siteurl') }}" class="d-inline-flex align-items-center">
                <span class="{{ env('APP_WARNA') }} logo-text ms-2 fw-semibold d-none d-sm-inline-block">{{
                    env('APP_NAME') }}</span>
                <span class="{{ env('APP_WARNA') }} logo-text ms-2 fw-semibold d-inline-block d-sm-none">{{
                    substr(env('APP_NAME'), 0, 1) }}</span>
            </a>
        </div>
            ...
            <ul class="nav gap-1 justify-content-center flex-nowrap flex-xl-wrap mx-auto">
                                ...
                                <div class="tab-pane dropdown-scrollable-xl fade p-3" id="tab_navbars" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mb-3 mb-lg-0">
                                            ...
                                            <a href="navbar_multiple_top_static.html" class="dropdown-item rounded">Top
                                                static</a>
                                            <a href="navbar_multiple_top_fixed.html" class="dropdown-item rounded">Top
                                                fixed</a>
                                        ...
                                        <div class="col-lg-3 mb-3 mb-lg-0">
                                            ...
                                            <a href="navbar_component_single.html" class="dropdown-item rounded">Single
                                                navbar</a>
                                ...
                                <div class="tab-pane dropdown-scrollable-xl fade p-3" id="tab_sidebar_types"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 mb-3 mb-lg-0">
                                            ...
                                            <a href="sidebar_default_color_dark.html" class="dropdown-item rounded">Dark
                                                color</a>
                                        </div>
                                        ...
                                        <div class="col-lg-3 mb-3 mb-lg-0">
                                            ...
                                            <a href="sidebar_right_color_dark.html" class="dropdown-item rounded">Dark
                                                color</a>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <a href="sidebar_content_color_dark.html" class="dropdown-item rounded">Dark
                                                color</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a href="navigation_horizontal_disabled.html"
                                                class="dropdown-item rounded">Disabled items</a>
                                            <a href="navigation_horizontal_mega.html" class="dropdown-item rounded">Mega
                                                menu</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <li class="nav-item nav-item-dropdown-xl dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @endcan
                        @can('master_gejala')
                        <a href="{{ route('master.gejala.index') }}" class="dropdown-item {{ $title == 'Gejala' ? 'active' : '' }}">
                            <i class="ph-gear-six me-2"></i>
                            Gejala
                        </a>
                        @endcan
                        @can('master_rule')
                        <a href="{{ route('master.rule.index') }}" class="dropdown-item {{ $title == 'Rule' ? 'active' : '' }}">
                            <i class="ph-gear-six me-2"></i>
                            Rule
                        </a>
                        @endcan
